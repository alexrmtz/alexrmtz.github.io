...
var PageName = 'In-class uses of Technology';
var PageId = 'pe5c78985b235405380daec5fb18433ed'
var PageUrl = 'In-class_uses_of_Technology.html'
document.title = 'In-class uses of Technology';
...
if (true) {
	...
	self.location.href="http://digitalcommons.pace.edu/cgi/viewcontent.cgi?article=1224&context=plr&sei-redir=1#search=%22Michael+Josephson,+Learning+and+Evaluation+in+Law+School+%281984%29.%22" + "";
...
if (true) {
	...
	self.location.href="Specific_rubics.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="http://www.eric.ed.gov/PDFS/ED299922.pdf" + "";
...
if (true) {
	...
	self.location.href="Exams.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="Constructivist.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="Hybrid_Blended_Learning.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="Assessment.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="Learning_theory.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="http://www.josseybass.com/WileyCDA/WileyTitle/productCd-1555425003.html" + "";
