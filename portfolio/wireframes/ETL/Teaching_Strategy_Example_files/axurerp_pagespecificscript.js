...
var PageName = 'Teaching Strategy Example';
var PageId = 'pebc9859a425f43d9bf986a6ee59ceb24'
var PageUrl = 'Teaching_Strategy_Example.html'
document.title = 'Teaching Strategy Example';
...
if (true) {
	...
	self.location.href="Case_Method.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="Jigsaw_Technique.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="Comprehensive_Assessment.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="Debates.html" + GetQuerystring();
